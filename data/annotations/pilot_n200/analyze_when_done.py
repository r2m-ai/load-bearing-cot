...
`data/annotations/pilot_n200/results_n200.json` with all numbers.

Usage:
  python3 data/annotations/pilot_n200/analyze_when_done.py \\
      --annotated data/annotations/pilot_n200/data_to_label_DONE.csv \\
...
def probe_vs_human(joined, probe_ckpt_path: Path) -> dict | None:
    ...
    these 200 examples. See `experiments/probes/reframed_probe.py` for the
