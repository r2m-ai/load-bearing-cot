...
H200 via `experiments/probes/extract_human_annotation_features.py`; sanity
...
1. **Bug fixed**: the earlier `experiments/probes/probe_vs_human.py` did
   ...
   `pair_ids`-keyed lookup used by `experiments/probes/retrain_probes.py`:
...
- Source script: `experiments/probes/probe_vs_human.py`
- Feature extraction script: `experiments/probes/extract_human_annotation_features.py`
