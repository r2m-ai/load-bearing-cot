...
from experiments/pipeline/perturb_and_continue.py (perturb_gsm8k_arithmetic /
...
Usage:
  python experiments/controls/hard_task_numerical_perturbations.py --stage probe
  python experiments/controls/hard_task_numerical_perturbations.py --stage generate \
        --groups bbh_computational            # add ,mmlu_numeric if probe passes
  python experiments/controls/hard_task_numerical_perturbations.py --stage judge \
...
from perturbation_helpers import parse_cot_steps, extract_gsm8k_answer, extract_mmlu_answer  # noqa: E402
...
# experiments/pipeline/perturb_and_continue.py so this arm is matched to the GSM8K rows.

_P2 = _load_module("pipeline/perturb_and_continue.py", "create_perturbations_2")
