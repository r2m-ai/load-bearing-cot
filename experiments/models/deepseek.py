...
`experiments/models/llama.py` in three load-bearing places — everywhere
...
Usage:
  python experiments/models/deepseek.py
  python experiments/models/deepseek.py --skip-to step4
  python experiments/models/deepseek.py --max-examples 200 \\
