...
Usage:
  python experiments/models/base_gemma_fewshot.py --stage full
  python experiments/models/base_gemma_fewshot.py --stage viability
"""
...
_E32 = _load("models/base_gemma.py", "exp_3_2")
