...
The DeepSeek pipeline (experiments/models/deepseek.py)
...
(experiments/pipeline/judge_behaviors.py).
...
Usage:
  python experiments/models/judge_deepseek.py --api-key $ANTHROPIC_API_KEY
"""
...
INPUT = ROOT / "results" / "models" / "deepseek" / "step3_subclassified.json"
OUTPUT = ROOT / "results" / "models" / "deepseek" / "step3_labeled.json"
LOG_DIR = ROOT / "logs"
