...
Usage:
  python experiments/steering/multi_direction.py --stage extract
  python experiments/steering/multi_direction.py --stage steer
  python experiments/steering/multi_direction.py --stage judge \\
...
def select_198set(clear_pairs, n_per_type, exclude_first):
    ...
    order. Deterministic; matches experiments/steering/single_direction.py:657-668.
    """
...
def rule_classify(rec, sub2b):
    ...
    pipeline (matched to experiments/pipeline/classify_behaviors.py). 2b only exposes
