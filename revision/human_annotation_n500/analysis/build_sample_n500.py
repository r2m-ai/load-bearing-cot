...
(`revision/human_annotation/`):
  ...
  1. TRUE M3 stratification. The n=200 sample predated item 2.0 and used
     ...
     `revision/revision_exp_results/exp_2_0_judge/stratification.json`:
...
Usage:
  python3 revision/human_annotation_n500/analysis/build_sample_n500.py
"""
...
STRATIFICATION = (REPO / "revision" / "revision_exp_results" /
                  "exp_2_0_judge" / "stratification.json")
OLD_META = REPO / "revision" / "human_annotation" / "_analysis_metadata.csv"
