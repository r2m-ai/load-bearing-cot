...
Reuses the exact extraction logic from `scripts/10_mlp_layer_sweep.py`:
...
Usage:
  ...
  python revision/scripts/exp_2_3_extract_annot_features.py
  ...
  python revision/scripts/exp_2_3_extract_annot_features.py --sanity-only
...
META_CSV = ROOT / "revision" / "human_annotation" / "_analysis_metadata.csv"
...
# ---------------------------------------------------------------------------
# Reused verbatim from scripts/10_mlp_layer_sweep.py for bit-exact parity
# ---------------------------------------------------------------------------
